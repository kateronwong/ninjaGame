...
public class Player_Movement_N : Movement
{
    ...
    private Player_Animation_Control_N PAC;
    ...
    void Awake()
    {
        ...
        PAC = GetComponentInChildren<Player_Animation_Control_N>();
    ...
    protected virtual Vector3 CalculateMovementVelocity()
    {
        ...
        {
            PAC.OnAnimatorMove();
            _velocity = PAC.rootMotionVelocity;
            Debug.Log("anim v: " + _velocity);
            return _velocity;
        }
        else
        {
    ...
    private void DetermineMovementState()
    {
        ...
        {
            currentMovementState = MovementState.Freezing;
            movementSpeed = 0;
            SetMomentum(Vector3.zero);
        }
        else if (IsSprintKeyPressed() && mover.IsGrounded())
        {
    ...
    public Vector3 CalculateJumpVelocity(Vector3 startPoint, Vector3 endPoint, float trajectoryHeight)
    {
        ...
        Debug.Log(displacementY + "  " + trajectoryHeight + "  " + gravity);
    ...
    public void JumpToPosition(Vector3 targetPosition, float trajectoryHeight)
    {
        ...
        Invoke(nameof(SetGrapplingVelocity), 0.1f);
